...
{    
   ...
   void PositionControl::jointposition_mode()
   {
       ...
       can_frame_msg1.id =  CAN_ID_BASE+0x01;
       ...
       can_frame_msg1.id =  CAN_ID_BASE+0x02;
       pub_.publish(can_frame_msg1);
       ros::Duration(0.25).sleep();//确保信息有时间发送
       can_frame_msg1.id =  CAN_ID_BASE+0x03;
       pub_.publish(can_frame_msg1);
       ros::Duration(0.25).sleep();//确保信息有时间发送
       can_frame_msg1.id =  CAN_ID_BASE+0x04;
       pub_.publish(can_frame_msg1);
       ros::Duration(0.25).sleep();//确保信息有时间发送
       can_frame_msg1.id =  CAN_ID_BASE+0x05;
       pub_.publish(can_frame_msg1);
       ros::Duration(0.25).sleep();//确保信息有时间发送
       can_frame_msg1.id =  CAN_ID_BASE+0x06;
       pub_.publish(can_frame_msg1);
       ros::Duration(0.25).sleep();//确保信息有时间发送
       can_frame_msg1.id =  CAN_ID_BASE+0x07;
       pub_.publish(can_frame_msg1);
       ros::Duration(0.25).sleep();//确保信息有时间发送
    ...
    void PositionControl::jointenable1()
    {
        ...
        can_frame_msg2.id =  CAN_ID_BASE+0x01;
        ...
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg2.id =  CAN_ID_BASE+0x02;
        pub_.publish(can_frame_msg2);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg2.id =  CAN_ID_BASE+0x03;
        pub_.publish(can_frame_msg2);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg2.id =  CAN_ID_BASE+0x04;
        pub_.publish(can_frame_msg2);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg2.id =  CAN_ID_BASE+0x05;
        pub_.publish(can_frame_msg2);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg2.id =  CAN_ID_BASE+0x06;
        pub_.publish(can_frame_msg2);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg2.id =  CAN_ID_BASE+0x07;
        pub_.publish(can_frame_msg2);
        ros::Duration(0.25).sleep();//确保信息有时间发送
    ...
    void PositionControl::jointenable2()
    {
        ...
        can_frame_msg3.id =  CAN_ID_BASE+0x01;
        ...
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg3.id =  CAN_ID_BASE+0x02;
        pub_.publish(can_frame_msg3);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg3.id =  CAN_ID_BASE+0x03;
        pub_.publish(can_frame_msg3);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg3.id =  CAN_ID_BASE+0x04;
        pub_.publish(can_frame_msg3);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg3.id =  CAN_ID_BASE+0x05;
        pub_.publish(can_frame_msg3);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg3.id =  CAN_ID_BASE+0x06;
        pub_.publish(can_frame_msg3);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg3.id =  CAN_ID_BASE+0x07;
        pub_.publish(can_frame_msg3);
        ros::Duration(0.25).sleep();//确保信息有时间发送
    ...
    void PositionControl::jointenable3()
    {
        ...
        can_frame_msg4.id =  CAN_ID_BASE+0x01;
        ...
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg4.id =  CAN_ID_BASE+0x02;
        pub_.publish(can_frame_msg4);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg4.id =  CAN_ID_BASE+0x03;
        pub_.publish(can_frame_msg4);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg4.id =  CAN_ID_BASE+0x04;
        pub_.publish(can_frame_msg4);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg4.id =  CAN_ID_BASE+0x05;
        pub_.publish(can_frame_msg4);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg4.id =  CAN_ID_BASE+0x06;
        pub_.publish(can_frame_msg4);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg4.id =  CAN_ID_BASE+0x07;
        pub_.publish(can_frame_msg4);
        ros::Duration(0.25).sleep();//确保信息有时间发送
    ...
    void PositionControl::velocityadd()
    {
        ...
        can_frame_msg5.id =  CAN_ID_BASE+0x01;
        ...
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg5.id =  CAN_ID_BASE+0x02;
        pub_.publish(can_frame_msg5);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg5.id =  CAN_ID_BASE+0x03;
        pub_.publish(can_frame_msg5);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg5.id =  CAN_ID_BASE+0x04;
        pub_.publish(can_frame_msg5);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg5.id =  CAN_ID_BASE+0x05;
        pub_.publish(can_frame_msg5);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg5.id =  CAN_ID_BASE+0x06;
        pub_.publish(can_frame_msg5);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg5.id =  CAN_ID_BASE+0x07;
        pub_.publish(can_frame_msg5);
        ros::Duration(0.25).sleep();//确保信息有时间发送
    ...
    void PositionControl::velocitydiff()
    {
        ...
        can_frame_msg6.id =  CAN_ID_BASE+0x01;
        ...
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg6.id =  CAN_ID_BASE+0x02;
        pub_.publish(can_frame_msg6);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg6.id =  CAN_ID_BASE+0x03;
        pub_.publish(can_frame_msg6);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg6.id =  CAN_ID_BASE+0x04;
        pub_.publish(can_frame_msg6);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg6.id =  CAN_ID_BASE+0x05;
        pub_.publish(can_frame_msg6);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg6.id =  CAN_ID_BASE+0x06;
        pub_.publish(can_frame_msg6);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg6.id =  CAN_ID_BASE+0x07;
        pub_.publish(can_frame_msg6);
        ros::Duration(0.25).sleep();//确保信息有时间发送
    ...
    void PositionControl::velocityset()
    {
        ...
        can_frame_msg7.id =  CAN_ID_BASE+0x01;
        ...
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg7.id =  CAN_ID_BASE+0x02;
        pub_.publish(can_frame_msg7);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg7.id =  CAN_ID_BASE+0x03;
        pub_.publish(can_frame_msg7);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg7.id =  CAN_ID_BASE+0x04;
        pub_.publish(can_frame_msg7);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg7.id =  CAN_ID_BASE+0x05;
        pub_.publish(can_frame_msg7);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg7.id =  CAN_ID_BASE+0x06;
        pub_.publish(can_frame_msg7);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg7.id =  CAN_ID_BASE+0x07;
        pub_.publish(can_frame_msg7);
        ros::Duration(0.25).sleep();//确保信息有时间发送
    ...
    void PositionControl::jointstart1()
    {
        ...
        can_frame_msg9.id =  CAN_ID_BASE+0x01;
        ...
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg9.id =  CAN_ID_BASE+0x02;
        pub_.publish(can_frame_msg9);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg9.id =  CAN_ID_BASE+0x03;
        pub_.publish(can_frame_msg9);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg9.id =  CAN_ID_BASE+0x04;
        pub_.publish(can_frame_msg9);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg9.id =  CAN_ID_BASE+0x05;
        pub_.publish(can_frame_msg9);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg9.id =  CAN_ID_BASE+0x06;
        pub_.publish(can_frame_msg9);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg9.id =  CAN_ID_BASE+0x07;
        pub_.publish(can_frame_msg9);
        ros::Duration(0.25).sleep();//确保信息有时间发送
    ...
    void PositionControl::jointstart2()
    {
        ...
        can_frame_msg11.id =  CAN_ID_BASE+0x01;
        ...
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg11.id =  CAN_ID_BASE+0x02;
        pub_.publish(can_frame_msg11);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg11.id =  CAN_ID_BASE+0x03;
        pub_.publish(can_frame_msg11);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg11.id =  CAN_ID_BASE+0x04;
        pub_.publish(can_frame_msg11);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg11.id =  CAN_ID_BASE+0x05;
        pub_.publish(can_frame_msg11);
        ros::Duration(0.25).sleep();//确保信息有时间发送
        can_frame_msg11.id =  CAN_ID_BASE+0x06;
        pub_.publish(can_frame_msg11);
        ros::Duration(0.25).sleep();//确保信息有时间发送
...
{
    // 初始化ROS节点
    ros::init(argc, argv, "RunMoveitTrajectory");
    ros::NodeHandle nh;
